...
popular_df = pd.read_pickle(os.path.join(path,'popular_books.pkl'))
pt =pd.read_pickle(os.path.join(path,'pt.pkl'))
books = pd.read_pickle(os.path.join(path,'books.pkl'))
similarity_scores = pd.read_pickle(os.path.join(path,'similarity_scores.pkl'))
